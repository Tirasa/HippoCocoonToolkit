...
public class JcrCategory extends TaxonomyObject implements EditableCategory {
    ...
    @Override
    public EditableCategory addCategory(final String key, final String name) throws TaxonomyException {
        try {
            return createCategory(getNode(), key, name);
        } catch (RepositoryException e) {
            throw new TaxonomyException("Could not create category with key " + key + ", name " + name, e);
        }
    }

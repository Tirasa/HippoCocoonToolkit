...
import static org.onehippo.taxonomy.plugin.TaxonomyEditorPlugin.LOG;
...
public class TaxonomyEditorPlugin extends RenderPlugin<Node> {
    ...
    private final class DescriptionModel implements IModel<String> {
        ...
        private static final long serialVersionUID = 674914554013108728L;
    ...
    private final class NameModel implements IModel<String> {
        ...
        private static final long serialVersionUID = 3021136544667606215L;
    ...
    protected final class LanguageSelection implements Serializable {
        ...
        private static final long serialVersionUID = 7703925271620566578L;
        ...
        public boolean equals(final Object o) {
            ...
            if (!(o instanceof TaxonomyEditorPlugin.LanguageSelection)) {
                return false;
            }

            if (languageCode == null && ((TaxonomyEditorPlugin.LanguageSelection) o).getLanguageCode() == null) {
                return true;
            }

            if (languageCode != null && languageCode.equals(((TaxonomyEditorPlugin.LanguageSelection) o).
                    getLanguageCode())) {
                return true;
            }
    ...
    private static final long serialVersionUID = -8900769810283586504L;
    ...
    private List<TaxonomyEditorPlugin.LanguageSelection> availableLanguageSelections;

    private TaxonomyEditorPlugin.LanguageSelection currentLanguageSelection;
    ...
    public TaxonomyEditorPlugin(final IPluginContext context, final IPluginConfig config) {
        ...
        currentLanguageSelection = new TaxonomyEditorPlugin.LanguageSelection(getLocale(), getLocale());
        ...
        tree = new TaxonomyTree("tree",
                new TaxonomyTreeModel(taxonomyModel, currentLanguageCode), currentLanguageCode) {

            private static final long serialVersionUID = 1974418158140828563L;
        ...
        AjaxLink<Void> addCategory = new AjaxLink<Void>("add-category") {
            ...
            private static final long serialVersionUID = 7324932909573375221L;
            ...
            public void onClick(final AjaxRequestTarget target) {
                ...
                dialogService.show(new NewCategoryDialog(taxonomyModel) {
                    ...
                    private static final long serialVersionUID = -705626161191219486L;
        ...
        ChoiceRenderer<TaxonomyEditorPlugin.LanguageSelection> choiceRenderer =
                new ChoiceRenderer<TaxonomyEditorPlugin.LanguageSelection>("displayName", "languageCode");
        DropDownChoice<TaxonomyEditorPlugin.LanguageSelection> languageSelectionChoice =
                new DropDownChoice<TaxonomyEditorPlugin.LanguageSelection>("language",
                new PropertyModel<TaxonomyEditorPlugin.LanguageSelection>(this, "currentLanguageSelection"),
        ...
        if (editing) {
            ...
            FormComponent<String> nameField = new TextField<String>("widget", new TaxonomyEditorPlugin.NameModel());
            ...
            container.add(new TextAreaWidget("description", new TaxonomyEditorPlugin.DescriptionModel()));
        } else {
            container.add(new Label("name", new TaxonomyEditorPlugin.NameModel()));
            TextField<String> keyField = new TextField<String>("key");
            keyField.setVisible(false);
            container.add(keyField);
            container.add(new MultiLineLabel("description", new TaxonomyEditorPlugin.DescriptionModel()));
        }

        container.add(new RefreshingView<String>("view") {

            private static final long serialVersionUID = -274717442179447260L;
            ...
            protected void populateItem(final Item<String> item) {
                item.add(new AjaxLink("up") {
                    ...
                    private static final long serialVersionUID = 6100152051298633795L;
                ...
                item.add(new AjaxLink("remove") {
                    ...
                    private static final long serialVersionUID = 1294695229281331042L;
     ...
     */
    protected JcrTaxonomy newTaxonomy(final IModel<Node> model, final boolean editing) {
    ...
    private List<TaxonomyEditorPlugin.LanguageSelection> getAvailableLanguageSelections() {
        List<TaxonomyEditorPlugin.LanguageSelection> languageSelections =
                new ArrayList<TaxonomyEditorPlugin.LanguageSelection>();

        for (String locale : taxonomy.getLocales()) {
            try {
                Locale localeObj = toLocale(locale);
                languageSelections.add(new TaxonomyEditorPlugin.LanguageSelection(localeObj, getLocale()));
            } catch (Exception e) {
                LOG.warn("Invalid locale for the taxonomy: {}", locale);
            }
        }

        TaxonomyEditorPlugin.LanguageSelection defaultLanguageSelection = new TaxonomyEditorPlugin.LanguageSelection(
                getLocale(), getLocale());
    ...
    public TaxonomyEditorPlugin.LanguageSelection getCurrentLanguageSelection() {
        return currentLanguageSelection;
    }

    public void setCurrentLanguageSelection(TaxonomyEditorPlugin.LanguageSelection currentLanguageSelection) {
     ...
     * @deprecated
     */
    private static Locale toLocale(final String str) {
        if (str == null) {
            return null;
        }
        int len = str.length();

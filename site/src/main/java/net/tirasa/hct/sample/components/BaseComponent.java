package net.tirasa.hct.sample.components;

import java.util.ArrayList;
import java.util.List;

import net.tirasa.hct.sample.componentsinfo.GeneralListInfo;
import net.tirasa.hct.sample.componentsinfo.PageableListInfo;

...
import org.onehippo.forge.hct.editor.beans.FilterBean.OperationType;
...
public class SummaryPanel extends Panel {
    ...
    private static final long serialVersionUID = 2998782520504460369L;
    ...
    public SummaryPanel(final String id, final String operation,
            final SummaryBean component, final String siteName) {
        super(id);
        ...
        final WebMarkupContainer filterContainer =
                new WebMarkupContainer("summaryFilterContainer");
        ...
        AjaxButton addAndButton = new IndicatingAjaxButton("addAndButton",
            ...
            protected void onSubmit(final AjaxRequestTarget target,
                ...
                FilterBean conditionWrapper = new FilterBean();
    ...
    private class Filter extends ListView<FilterBean> {
        ...
        private static final long serialVersionUID = 4122181591857292875L;
    }

    private class OrderBy extends ListView<OrderBean> {

        private static final long serialVersionUID = -6248046626672673913L;

        final private WebMarkupContainer orderContainer;
        ...
        protected void populateItem(
            ...
            final OrderBean orderCondition =
                    item.getModelObject();

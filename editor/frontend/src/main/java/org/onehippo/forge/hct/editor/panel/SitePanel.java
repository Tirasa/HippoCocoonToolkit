...
import org.onehippo.forge.hct.editor.forms.SiteForm;

public class SitePanel extends HctBreadCrumbPanel {

    private static final long serialVersionUID = 1832147074344581181L;

    public SitePanel(final String id, final IPluginContext context,
        ...
        add(new SiteForm("form", null, breadCrumbModel, feedmsg));
    }
    ...
    public SitePanel(final String id, final IPluginContext context,
        ...
        add(new SiteForm("form", model, breadCrumbModel, feedmsg));
    }

    @Override
    public final IModel<String> getTitle(final Component site) {
        return new StringResourceModel("site-create", site, null);
    }
}

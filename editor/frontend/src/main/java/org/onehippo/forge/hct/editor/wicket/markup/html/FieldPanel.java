 ...
 */
package org.onehippo.forge.hct.editor.wicket.markup.html;
...
public abstract class FieldPanel<T extends Serializable>
    ...
    public FieldPanel setTitle(final String title) {
        field.add(new SimpleAttributeModifier("title", title != null ? title : ""));
        return this;
    }
    ...
    public FieldPanel setRequired(final boolean required) {
        field.setRequired(required);

        return this;
    }

    public FieldPanel setReadOnly(final boolean readOnly) {
    ...
    @Override
    public FieldPanel setModelObject(final T object) {

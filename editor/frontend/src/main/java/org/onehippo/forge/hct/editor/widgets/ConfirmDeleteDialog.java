 ...
 */
package org.onehippo.forge.hct.editor.widgets;
...
public class ConfirmDeleteDialog extends AbstractDialog {
    ...
    private static final long serialVersionUID = -1532472875421184498L;
    ...
    public ConfirmDeleteDialog(final IModel model, final Component component) {
        ...
        add(new Label("label",
                new StringResourceModel(getTextKey(), component, model)));
        setFocusOnCancel();
    }
